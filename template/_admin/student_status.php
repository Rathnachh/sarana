            ...
            success: function(data) {
                if (data != 0) {
                    ...
                    $.each(data, function(key, value) {
                        $('tbody').append(
                            '<tr>\
                                <td class="kh-text text">0' + (n++) + '</td>\
                                <td class="kh-text">' + value.name + '</td>\
                                <td class="kh-text">' + value.feature + '</td>\
            ...
            success: function(data) {
                if (data != 0) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        $('tbody').append(
                            '<tr>\
                                <td class="kh-text">0' + (n++) + '</td>\
                                <td class="kh-text">' + value.status_name + '</td>\
                                <td class="text-info ">' + value.payment + ' ៛</td>\
                                <td class="kh-text">' + active + '</td>\
                                <td class="text-right kh-text">\
