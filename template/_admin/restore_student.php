...
<script>
            ...
            columns:[
                ...
                {'data':'id','name':'person_phone',AutoWidth:true,
                    'render':function(data,type,row){
                        ...
                        var view = '<a href="student_details.php?STU_ID='+data+'&link=restore_student.php?" class="btn btn-sm"><i class="fa-solid fa-eye text-info"></i></a>';
                        var remove = '<a href="#" class="btn btn-sm" id="remove_student" data-id ="'+row['id']+'"><i class="fa-solid fa-trash text-danger"></i></a>';
                        return btn_feature+view+remove;
                    }
                }
    ...
    function list_student()
    {
        $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data:{_select_student_restore:1},
            beforeSend:function()
            {
                $('#_loadData').show();
            },
