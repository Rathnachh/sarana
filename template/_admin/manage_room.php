                    ...
                    $.each(data, function(key, value) {
                        ...
                        $('tbody').append(
                            '<tr>\
                                ...
                                <td class="kh-text">' + value.name_room + '</td>\
                                <td class="kh-text">' + value.floor_name + '</td>\
                                <td class="kh-text">' + value.building_name + '</td>\
                                <td class="d-none kh-text">' + value.id_building + '</td>\
                                <td class="d-none kh-text">' + value.floor_id + '</td>\
                                <td class="d-none kh-text">' + value.descripton + '</td>\
