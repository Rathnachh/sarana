...
<div class="col-lg-12">
    ...
    <a href="manage_teacher.php"><i class="fa-solid fa-arrow-left mr-3 text-info" style="font-size:18px"></i></a>
        <h3 class="kh-text text-info font-weight-bold">ចុះឈ្មោះ</h3>
    </div>
    <div class="info-student my-3 ">
        <form autocomplete="off" method="post" enctype="multipart/form-data" role="form" class="register_form needs-validation" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control kh-text" placeholder="សូមវាយបញ្ចូល" required name="dob" id="dob">
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please fill out this field.</div>
                        </div>
                    </div>
            ...
            <hr class="" style="margin:0 0 20px 0px;">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="form-group">
