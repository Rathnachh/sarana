            ...
            <div class="row my-3">
                <div class="col-lg-3">
                    <select name="feature" id="feature" class="form-control">
                        ...
                        <option value="" class="kh-text">របាយការបង់ប្រាក់</option>
                        <!-- <option value="1" class="kh-text">របាយការនិស្សិតបានបង់ប្រាក់ហើយ</option>
                        <option value="0" class="kh-text">របាយការនិស្សិតមិនទាន់បង់ប្រាក់</option> -->
                    </select>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-3 d-flex  ">
                    <button type="button" id="search" class="form-control w-50 kh-text mr-2  btn btn-outline-info">ស្វែងរក</button>
                    <button type="button" id="print" class="form-control w-50 kh-text btn btn-info">បោះពុម្ភ</button>
                </div>
            </div>
            <div id="report" style="width: 1200px;margin: auto;padding: 20px 50px;background-color: none;">
                <div class="head" style="display: flex;justify-content: space-between;padding: 20px 0;">
                    <div class="left-head" style="text-align: center;font-family: 'Khmer OS Muol Light';margin-top: 5%;">
                        <h3 class="kh-text" style="line-height: 1.5;font-weight: bold;font-size: 17px;">ក្រសួងអប់រំយុវជន និងកីឡា</h3>
                        <h4 class="kh-text" style="line-height: 1.5;font-weight: bold;font-size: 17px;">សាកលវិទ្យាល័យហេង សំរិន ត្បូងឃ្មុំ</h4>
                    </div>
                ...
                <h3 style="text-align: center;font-size: 14px;font-family: 'Khmer OS Muol Light';" id="title_pay">របាយការណ៍បង់ប្រាក់</h3>
                <table class="table nowrap table-hover w-100 table-bordered">
                    <thead>
                        <tr>
                            <th class="d-none"></th>
                            <th class="kh-text">ល.រ</th>
                            <th class="w-25 text-dark kh-text">ឈ្មោះនិស្សិត</th>
                            <th class="">ភេទ</th>
                            <th class="w-25 text-dark kh-text">បានបង់ប្រាក់</th>
                            <th class="w-25 text-dark kh-text">មិនទាន់បង់ប្រាក់</th>
                            <th class="w-25 text-right kh-text">ថ្ងៃបង់ប្រាក់</th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <p class="text-end text-sucess kh-text">ប្រាក់ដែលបានបង់សរុប​ <span id="total_payment">0.00</span></p>
                <p class="text-end text-danger kh-text">ប្រាក់ដែលមិនទាន់បានបង់សរុប​ <span id="total_remain">0.00</span></p>
                <hr>
            </div>
        ...
        $('#search').click(function(){
            ...
            $.ajax({
                ...
                success:function(data)
                {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            $('tbody').append(
                                '<tr>\
                                    ...
                                    <td class="kh-text">'+value.fname+'</td>\
                                    <td class="kh-text">'+gender+'</td>\
                                    <td class="">'+value.paid+' ៛</td>\
                                    <td class="text-danger">'+value.remain+' ៛</td>\
                    ...
                    {
                        $('tbody').html('');
                        swal('បរាជ័យ', 'មិនមានរបាយការណ៍ សូមអរគុណ!!!','warning');
