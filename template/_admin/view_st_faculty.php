<?php require_once('../_layout/head.php') ;?>
        ...
        <?php
            ...
            if(isset($_GET['ST']))
            {
                ...
                WHERE st.faculty_id=$FA_ID AND st.feature = 1 AND st.student_type_id = 4 AND st.acept = 1";
        ...
        <div class="content shadow p-3">
            <div class="title d-flex">
                <a href="manage_faculty.php"><i class="fa-solid fa-arrow-left mr-3" style="font-size:18px"></i></a>
                <h3>និស្សិតដែលសិក្សានៅ <span><?php echo $_GET['BDN'] ?> ឆ្នាំ <?php echo date("Y")?></span></h3>
            </div>
                   ...
                   <tbody>
                        <?php
                            if($data_build->num_rows >0)
                            {
                                ...
                                {
                                    ?>
                                         <tr data-href="student_details.php?STU_ID=<?php echo $row['id']?>&link=view_st_faculty.php?ST=<?php echo $_GET['ST'] ?>&BDN=<?php echo $_GET['BDN']?>">
                                            <td><?php echo $n++; ?></td>
