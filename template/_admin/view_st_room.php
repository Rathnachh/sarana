<?php require_once('../_layout/head.php') ;?>
        ...
        <?php
            ...
            if(isset($_GET['ST']))
            {
                ...
                WHERE str.id=$room_id AND st.feature=1 AND st.acept = 1";
                   ...
                   <tbody>
                        <?php
                            if($data_build->num_rows >0)
                            {
                                ...
                                {
                                    ?>
                                         <tr data-href="student_details.php?STU_ID=<?php echo $row['id']?>&link=view_st_room.php?ST=<?php echo $_GET['ST'] ?>&BDN=<?php echo $_GET['BDN']?>&ROM=<?php echo $_GET['ROM']?>">
                                            <td><?php echo $n++; ?></td>
