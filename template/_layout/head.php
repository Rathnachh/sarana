            ...
            <nav>
                ...
                <div class="menu">
                    <ul class="">
                        ...
                        <li>
                            <a data-toggle="collapse" href="#collapseExample" class="d-flex justify-content-between align-items-center" role="button" aria-expanded="false" aria-controls="collapseExample"><span>ការគ្រប់គ្រងអគារ </span><i class="fa-solid fa-angle-right"></i></a>
                        ...
                        <li>
                            <a data-toggle="collapse" href="#faculty" class="d-flex justify-content-between align-items-center" role="button" aria-expanded="false" aria-controls="faculty"><span>ការគ្រប់គ្រងវិទ្យាស្ថាន </span><i class="fa-solid fa-angle-right"></i></a>
                        ...
                        <li>
                            <a data-toggle="collapse" href="#addresses" class="d-flex justify-content-between align-items-center" role="button" aria-expanded="false" aria-controls="faculty"><span>ការគ្រប់គ្រងអាស័យដ្ឋាន </span><i class="fa-solid fa-angle-right"></i></a>
                    ...
                    <li>
                        <a data-toggle="collapse" href="#other" class="d-flex justify-content-between align-items-center" role="button" aria-expanded="false" aria-controls="faculty"><span>ការគ្រប់គ្រងផ្សេងៗ </span><i class="fa-solid fa-angle-right"></i></a>
