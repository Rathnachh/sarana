...
<div class="content shadow p-3 bg-white">
    <div class="title">
        <h3 class="font-weight-bold kh-text text-info">ព័ត៌មានរបស់និស្សិតដែលស្នាក់នៅអន្តេវាសិកដ្ឋានទាងអស់</h3>
    </div>
        ...
        <table class="table nowrap table-hover w-100 table-responsive" id="List_data_vihicle">
            <thead>
                <tr>
                    ...
                    <th class="w-25  kh-text text-info">ម៉ាក់ម៉ូត៉ូ</th>
                    <th class="w-25  kh-text text-info">ស្លាក់លេខម៉ូត៉ូ</th>
                    <th class="w-25  kh-text text-info">ថ្ងៃខែចុះបញ្ចី</th>
                    <th class="w-25​  kh-text text-info​ text-right">ប៉ូតុង</th>
                </tr>
            </thead>
            <!-- <tbody>
                        <tr>
