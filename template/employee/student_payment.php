        ...
        <table class="table nowrap table-hover w-100 table-responsive" id="data_info_payment">
            <thead>
                <tr>
                    ...
                    <th class="w-25 text-success kh-text">បានបង់ប្រាក់</th>
                    <th class="w-25 text-info kh-text">មិនទាន់បង់ប្រាក់</th>
                    <th class="w-25 kh-text">ថ្ងៃបង់ប្រាក់</th>
                    <th class="w-50 text-right kh-text">ថ្ងៃបញ្ចប់ការបង់ប្រាក់</th>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
        ...
        datatable = $('#data_info_payment').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    data: 'paid',
                    AutoWidth: true,
                    className: 'kh-text text-success',
                    'render': function(data) {
