...
<div class="content p-3">
    <div class="title title d-flex align-items-center">
        <h3 class="kh-text font-weight-bold text-info">បផ្លាស់ប្តូរពាក្យសម្ងាត់</h3>
    </div>
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-4">
            <form id="form_change">
                ...
                <div class="form-group">
                    <label for="" class="kh-text">ពាក្យសម្ងាត់ថ្មីម្តងទៀត </label>
                    <input type="password" id="confirm_password" name="confirm_password" class="form-control" required>
                </div>
                <!-- <div class="d-flex justify-content-center"> -->
                    <button type="submit" class="w-100 btn btn-outline-info kh-text">រក្សាទុក</button>
                <!-- </div> -->
            </form>
        </div>
    </div>
